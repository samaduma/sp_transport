...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    (el) => {
      ...
      overlay.style.transition = `transform ${enlargeTransitionMs}ms cubic-bezier(0.34, 1.56, 0.64, 1), opacity ${enlargeTransitionMs}ms ease`
      overlay.style.borderRadius = openedImageBorderRadius
      overlay.style.boxShadow = "0 20px 60px rgba(0, 0, 0, 0.5), 0 0 60px rgba(0, 0, 0, 0.3)"
          ...
          <div ref={sphereRef} className="sphere">
            {items.map((it, i) => (
              ...
              >
                ...
                >
                  <img src={it.src || "/placeholder.svg"} draggable={false} alt={it.alt} />
                </div>
              </div>
            ))}
          </div>
